        ...
        <div className="row p-5">
          <div className="col-md-12 d-flex justify-content-end">
            <button className=" add-contact btn btn-success">
              <Link to="/add-contact" style={{ color: "white" }}>
                Add a New Contact
              </Link>
            </button>
          </div>
              ...
              <div className="row border-bottom py-3">
                <div className="col-2">
                  <img
                    ...
                    src="https://tse2.mm.bing.net/th?id=OIP.ncOCV5LVCL8j70Edjgyn6QHaGy&pid=Api"
                  />
                </div>
                <div className="col-8">
                  ...
                  <p className="text-white">
                    ...
                    <span className="text-dark ms-3">{props.item.address}</span>
                  </p>
                  <p className="text-white">
                    <i className="fas fa-at text-secondary"></i>
                    <span className="text-dark ms-3"> {props.item.email}</span>
                  </p>
                  <p className="text-white">
                    <i className="fas fa-phone text-secondary"></i>
                    <span className="text-dark ms-3">{props.item.phone}</span>
                  </p>
                </div>
