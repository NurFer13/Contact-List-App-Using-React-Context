...
//CREATE CONTACT BOOK      
export const createContactBook = (ContactBook) => {
...
export const getAllContactBook = (setState,agenda_slug) => {
...
export const deleteContactT = (contact_id) => {
    return fetch(`https://assets.breatheco.de/apis/fake/contact/${contact_id}`,{
        method:"DELETE",
        headers: {
            "Content-type": "application/json"
...
export const deleteAllContactBook = (agenda_slug) => {
    return (fetch(`https://assets.breatheco.de/apis/fake/contact/contact-book/${agenda_slug}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json"
